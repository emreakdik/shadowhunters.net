...
<div class="slide-container d-flex justify-content-center align-content-center flex-wrap">
 ...
 sort($json_a["alan-kartlari"]);
 for ($i=0;$i< count($json_a["alan-kartlari"]);$i++)
 {
 ?> 
  <div class="wrapper">
    <div class="clash-card giant" id="1">
      <div class="clash-card__image clash-card__image--barbarian">
        <img src="assets/img/<?php echo $json_a["alan-kartlari"][$i]["image"]; ?>"/>
      </div>
      <div class="clash-card__unit-name"> <?php echo $json_a["alan-kartlari"][$i]["baslik"]; ?> </div>
      <div class="clash-card__level clash-card__level--barbarian"><?php echo $json_a["alan-kartlari"][$i]["uyari"]; ?></div>
      <div class="clash-card__unit-description">
      <?php echo $json_a["alan-kartlari"][$i]["aciklama"]; ?>
      </div>
