...
<div class="slide-container d-flex justify-content-center align-content-center flex-wrap">
 ...
 sort($json_a["saldiri-kartlari"]);
 for ($i=0;$i< count($json_a["saldiri-kartlari"]);$i++)
 {
 ?> 
  <div class="wrapper">
    <div class="clash-card archer" id="1">
      <div class="clash-card__image clash-card__image--archer">
        <img src="assets/img/<?php echo $json_a["saldiri-kartlari"][$i]["image"]; ?>"/>
      </div>
      <div class="clash-card__unit-name"> <?php echo $json_a["saldiri-kartlari"][$i]["baslik"]; ?> </div>
      <div class="clash-card__level clash-card__level--archer"><?php echo $json_a["saldiri-kartlari"][$i]["uyari"]; ?></div>
      <div class="clash-card__unit-description">
      <?php echo $json_a["saldiri-kartlari"][$i]["aciklama"]; ?>
      </div>
