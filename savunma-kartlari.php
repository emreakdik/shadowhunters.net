...
<div class="slide-container d-flex justify-content-center align-content-center flex-wrap">
 ...
 sort($json_a["savunma-kartlari"]);
 for ($i=0;$i< count($json_a["savunma-kartlari"]);$i++)
 {
 ?> 
  <div class="wrapper">
    <div class="clash-card goblin" id="1">
      <div class="clash-card__image clash-card__image--archer">
        <img src="assets/img/<?php echo $json_a["savunma-kartlari"][$i]["image"]; ?>"/>
      </div>
      <div class="clash-card__unit-name"> <?php echo $json_a["savunma-kartlari"][$i]["baslik"]; ?> </div>
      <div class="clash-card__level clash-card__level--goblin"><?php echo $json_a["savunma-kartlari"][$i]["uyari"]; ?></div>
      <div class="clash-card__unit-description">
      <?php echo $json_a["savunma-kartlari"][$i]["aciklama"]; ?>
      </div>
